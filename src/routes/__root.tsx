...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Strategists & CEOs — Sun Tzu and Machiavelli in Modern Business" },
      { name: "twitter:title", content: "Strategists & CEOs — Sun Tzu and Machiavelli in Modern Business" },
      { property: "og:description", content: "How the strategies of Sun Tzu and Machiavelli shape the modern business world, with an interactive strategy puzzle." },
      { name: "twitter:description", content: "How the strategies of Sun Tzu and Machiavelli shape the modern business world, with an interactive strategy puzzle." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39b52558-c7ed-4871-a2a0-2528f45f3036/id-preview-2ef233b1--718d45d0-fd01-44d6-9fbe-c8ebd98467a7.lovable.app-1779159562991.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39b52558-c7ed-4871-a2a0-2528f45f3036/id-preview-2ef233b1--718d45d0-fd01-44d6-9fbe-c8ebd98467a7.lovable.app-1779159562991.png" },
